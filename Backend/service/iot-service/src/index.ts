...
fastify.post('/api/iot/simulate/start', (req, res) => iotController.startRealtimeSimulation(req, res));
fastify.post('/api/iot/simulate/stop', (req, res) => iotController.stopRealtimeSimulation(req, res));
fastify.get('/api/iot/simulate/status', (req, res) => iotController.getRealtimeSimulationStatus(req, res));
